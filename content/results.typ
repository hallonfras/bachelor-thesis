...
#TODO("Update figures as i continue to annotate them")

#TODO("I should also see if i can use Henriks script to manually make the models a bit more readable.")
...
I have used this alphabet while learning all models except windows, where SA had to be removed because it caused nondeterminism.
...
The Linux model has a cluster of states labelled s5, s4 and s8. These i have categorised as a kind of miscellaneous state. Almost all of the transitions to and from these have timeout as the output symbol so they likely represent some kind of "stuck" state.
