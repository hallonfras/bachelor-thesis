...
#TODO("Specify which OSes the have been applied to when known")
...
This thesis details the implementation details of TCP-Fuzzer as well as possible future improvements to the tool. In addition I have used TCP-Fuzzer to learn the state machines of several different OS TCP stacks the results of which will be detailed in this thesis.
