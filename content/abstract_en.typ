...
Protocol state fuzzing is a method for constructing state-machine representations of protocol-behavior in a black-box manner. These state machines can then be used for things such as model-based conformance testing or fingerprinting.
