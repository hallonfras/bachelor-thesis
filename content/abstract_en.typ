...
This thesis details the implementation details of TCP-Fuzzer as well as possible future improvements to the tool. In addition I have used TCP-Fuzzer to learn the state machines of the windows, linux and macOS TCP stacks. The results of which will be detailed in this thesis.
